package com.example.administrator.chattiong.Receive;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onMessage(Context context, String message,
        ...
        if (!TextUtils.isEmpty(message)) {
            Gson gson = new Gson();
            try {
                JSONObject array = new JSONObject(message);
                Log.d(TAG, array.toString());
                news = gson.fromJson(array.toString(), News.class);
                news.save(); //推送到的消息进行存储
            } catch (Exception e) {
                e.printStackTrace();
            }
        }

        messageString += "------------------" + news.toString();
    ...
    private void updateContent(Context context, String content) {
        ...
        intent.putExtra("result", logText);
